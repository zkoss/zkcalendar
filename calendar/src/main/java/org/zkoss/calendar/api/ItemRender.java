...
public interface ItemRender {
	 ...
	 */
	public String drawDay(Calendars cal, CalendarItem evt, String id);

	/**
	 * Draws the all day in the default mold of the calendar.
	 * @param id auto-created by the calendars component
	 */
	public String drawAllDay(Calendars cal, CalendarItem evt, String id);

	/**
	 * Draws the day in the month mold of the calendar.
	 * @param id auto-created by the calendars component
	 */
	public String drawDayByMonth(Calendars cal, CalendarItem evt, String id);

	/**
	 * Draws the all day in the month mold of the calendar.
	 * @param id auto-created by the calendars component
	 */
	public String drawAllDayByMonth(Calendars cal, CalendarItem evt, String id, Date begin, Date end);
}
